...
- [x] Mention two parts of Express that you learned about this week.
    _This week we learned about routing, as well as methods like .send and .status._

- [x] Describe Middleware?
    _Middleware refers to functions that add features to Express and are executed in the order in which you write them._

- [x] Describe a Resource?
    _**Resources** are part of the idea of REST. Everything is a resource, and each resource has its own URL that allows you to access it._

- [x] What can the API return to help clients know if a request was successful?
    _APIs can return status codes, along with messages, to indicate whether or not a request was successful, and if not, why._

- [x] How can we partition our application into sub-applications?
    _Just like in React, we can break our code into components, only in Node, they are called modules. You can break them apart by category, functionality, or Routes. Traditionally, each piece of Middleware has its own module, as well as each set of routes and each data model._
